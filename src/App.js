    ...
    return (
      <ThemeProvider theme={Theme}>
        <React.Fragment>
          ...
          <Section name={sections[0]} blurb="Read what this year's keynote speakers had to say to graduating Columbia College, School of Engineering and Applied Science, General Studies, and Barnard students." data={GlobalData[sections[0]]} _ref={this.classDaysRef}/>
          <Section name={sections[1]} blurb="Across the four undergraduate schools, the class of 2019 boasts exceptional leaders, thinkers, athletes, and artists. Here is a selection of the graduating seniors who have made a lasting impact on the campus community." data={GlobalData[sections[1]]} _ref={this.seniorProfRef}/>
          <Section name={sections[2]} blurb="Members of Spectator’s graduating class reflect on what they’ve learned and how they’ve grown from their time at the organization." data={GlobalData[sections[2]]} _ref={this.seniorColRef}/>
        </React.Fragment>
      </ThemeProvider>
    );
  }
